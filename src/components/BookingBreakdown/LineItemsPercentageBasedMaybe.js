/**
 * Renders line items that have a `percentage` attribute and are not listed in the
...
LineItemsPercentageBasedMaybe.propTypes = {
  transaction: propTypes.transaction.isRequired,
  intl: intlShape.isRequired,
};

export default LineItemsPercentageBasedMaybe;
